/*
 * Page Cas signature — Festival International du Film d'Oran (Algérie)
 * L'histoire de l'écran 12 m monté sur une place publique, dont l'organisateur
 * a fait appel à l'armée pour décrocher les lampions trop bas.
 *
 * ⚠️ Photos actuellement placeholders (urbain/centre-ville) — à remplacer par
    ...
    <PageShell>
      <PageStructuredData
        breadcrumbs={[
          ...
          { name: "Festival d'Oran", routeKey: "cas-oran" },
        ]}
        page={{
          name: t("meta_title"),
