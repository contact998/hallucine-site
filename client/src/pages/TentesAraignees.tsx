      ...
      <section className="py-16 bg-background">
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { src: "https://www.hallucinecran.com/Tentes/Tents%20spider/Sider%20tentes%20bleues.jpg", alt: "Tentes araignées bleues" },
              { src: "https://www.hallucinecran.com/photoset/Tents%20spider/Sider%20tentes%20rideau%20jaunes.jpg", alt: "Tentes araignées avec rideaux jaunes" },
              { src: "https://www.hallucinecran.com/photoset/Tents%20spider/Sider%20tentes%20vertes.png", alt: "Tentes araignées vertes" },
              { src: "https://www.hallucinecran.com/photoset/Tents%20spider/Sider%20tentes%20noir%20jaunes.jpg", alt: "Tentes araignées noir et jaune" },
