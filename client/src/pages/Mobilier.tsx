    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img loading="lazy" src="/manus-storage/jCghaPHMczbtTjIn_800w_e88b9440.webp" alt="Mobilier gonflable Hallucine en plein air" className="w-full h-full object-cover" style={{ objectPosition: 'center 20%' }} decoding="async" srcSet="/manus-storage/jCghaPHMczbtTjIn_400w_e4f184dc.webp 400w, /manus-storage/jCghaPHMczbtTjIn_800w_e88b9440.webp 800w, /manus-storage/jCghaPHMczbtTjIn_1200w_e218a3ef.webp 1200w" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 600px" />
