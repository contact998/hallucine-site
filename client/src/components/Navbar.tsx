      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-[oklch(0.10_0.015_260)] border-b border-white/5 text-xs text-white/70 overflow-visible">
        <div className="container flex items-center justify-between py-1.5">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <a href="https://www.youtube.com/@Hallucineecrantentestructure" target="_blank" rel="noopener noreferrer" className="hover:text-warm transition-colors p-2 -m-1.5 inline-flex items-center justify-center" aria-label="YouTube">
