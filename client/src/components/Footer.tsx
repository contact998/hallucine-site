        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a href="https://www.youtube.com/@Hallucineecran" target="_blank" rel="noopener noreferrer" className="w-11 h-11 flex items-center justify-center rounded bg-white/5 hover:bg-warm/20 text-white/70 hover:text-warm transition-colors" aria-label="YouTube">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "sameAs": [
              ...
              "https://www.youtube.com/@Hallucineecran"
            ]
          })
        }}
      />
